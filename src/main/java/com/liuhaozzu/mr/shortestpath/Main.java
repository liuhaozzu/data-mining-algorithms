package com.liuhaozzu.mr.shortestpath;
...
public final class Main {
	...
	public static void main(String... args) throws Exception {
		...
		String inputFile = "/usr/input/shortestpath/data";
	...
	static {
		 ...
		 */
		conf.set("mapred.jar",
				"D:\\git-repos\\data-mining-algorithms\\target\\data-mining-algorithms-0.0.1-SNAPSHOT.jar");
	}

	public static void iterate(String startNode, String targetNode, String input, String output) throws Exception {
	...
	public static void createInputFile(Path file, Path targetFile, String startNode) throws IOException {
		FileSystem fs = file.getFileSystem(conf);

		OutputStream os = fs.create(targetFile);
		LineIterator iter = org.apache.commons.io.IOUtils.lineIterator(fs.open(file), "UTF8");
		while (iter.hasNext()) {
	...
	public static boolean findShortestPath(Path inputPath, Path outputPath, String startNode, String targetNode)
			throws Exception {
